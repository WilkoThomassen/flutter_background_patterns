...
void main() {
  test('basic shape depth tests', () {
    expect(const Offset(0, 0).withDepth(depth: 1, size: 100), const Offset(50.0, 0.0));
    expect(const Offset(0, 25).withDepth(depth: 1, size: 100), const Offset(37.5, 25.0));

    expect(const Offset(80, 0).withDepth(depth: 1, size: 100), const Offset(30.0, 0.0));
    expect(const Offset(80, 75).withDepth(depth: 1, size: 100), const Offset(67.5, 75.0));

    expect(const Offset(80, 0).withDepth(depth: 0.6, size: 100), const Offset(50.0, 0.0));
