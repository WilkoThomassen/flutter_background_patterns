...
class CustomBackgroundPattern extends StatefulWidget {
  const CustomBackgroundPattern({super.key});

  @override
  CustomBackgroundPatternState createState() => CustomBackgroundPatternState();
}

class CustomBackgroundPatternState extends State<CustomBackgroundPattern> {
  ...
  Widget build(BuildContext context) {
    ...
    return PatternContainer(
        ...
        shapes: [
          CustomConfig(customPath: customStarPath),
          CustomConfig(customPath: customStarPath, isOutlined: true)
        ],
